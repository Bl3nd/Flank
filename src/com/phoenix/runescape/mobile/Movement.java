...
import com.phoenix.runescape.network.packet.dispatch.RegionalUpdatePacket;
...
public final class Movement {
	...
	/**
	 * Handles the cycling movement requests of the entity. This method
	 * receives prior processing to the main updating procedure to ensure that
	 * all movement is registered in time to be updated in synchronization with the
	 * main procedure.
	 */
	...
	public final MovementPoint getNextPoint() {
		...
		if (availableFocusPoint == null || availableFocusPoint.getDirection() == -1) {
			...
			getEntity().getPosition().setPositionAdditional(Constants.DIRECTION_DELTA_X[availableFocusPoint.getDirection()], Constants.DIRECTION_DELTA_Y[availableFocusPoint.getDirection()], getEntity().getPosition().getPlane());
