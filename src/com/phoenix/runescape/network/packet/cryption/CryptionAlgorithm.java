 ...
 * 
 * An implementation of Bob Jenkins's encryption key.
 */
public final class CryptionAlgorithm {
	...
	/**
	 * Utilized for pseudo-random lookup.
	 */
	...
	/**
	 * Returns the next value in the algorithm.
	 * 
	...
	public void generateResults() {
		...
		for(i = 0, j = SIZE / 2; i < SIZE / 2;) {
			...
			results[i++] = lastResult = memory[((y >> SIZE_LOG) & MASK) >> 2] + x;
			x = memory[i];
	...
	/**
	 * Initializes the ISAAC algorithm.
	 * 
	 * @param pass Indicates if a second pass is required.
	 */
	public void initialize(boolean pass) {
